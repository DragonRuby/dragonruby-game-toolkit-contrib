: <<'COMMENT'
fswatch ./samples/10_advanced_debugging/03_unit_tests/enumerable_class_function_tests.rb | xargs -n1 -I{} sh ./samples/10_advanced_debugging/03_unit_tests/run-tests.sh
set -e
rake
COMMENT
