...
|                                | `scale_quality`            | `0`, `1`, `2`, `3` (default is `0`)                                          | Specifies the render scale quality for your game (0=nearest neighbor, 1=anisotropic/best, 2=anisotropic/best, 3=pixelart). Full details of what each number means in `metadata/game_metadata.txt`. |
